    ...
    with preview_tab:
        ...
        st.markdown(
            ...
            <style>
              ...
              .monthly-title {{ font-weight: 700; margin: 0 0 7px; padding-left: 2.2em; text-indent: calc(1mm - 2.2em); line-height: 1.45; }}
              .monthly-item {{ margin: 3px 0 0; padding-left: 3.1em; text-indent: calc(1mm - 3.1em); line-height: 1.55; }}
